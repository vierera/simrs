...
if (isset($_GET['page'])) {
	...
	switch ($_GET['page']) {
		...
		case 'lap-rekam-medis':
			...
			break;
        case 'lap-pasien':
            require_once 'app/laporan/views/pasien.php';
            break;
        case 'transaksi':
            require_once 'app/transaksi/views/index.php';
            break;
        case 'tambah-transaksi':
            require_once 'app/transaksi/views/create.php';
            break;
        case 'edit-transaksi':
            require_once 'app/transaksi/views/edit.php';
            break;
        case 'hapus-transaksi':
            require_once 'app/transaksi/proses/delete.php';
            break;
	}
} else {
