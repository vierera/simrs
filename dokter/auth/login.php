...
$url2 = 'http://localhost/SIMRS/index2.php';
...
if (isset($_POST['login'])) {
  ...
  if (mysqli_num_rows($query) === 1) {
    ...
    if (password_verify($password, $row['password'])) {
      ...
      elseif($role==2){
      echo '<script>document.location.href="' . $url2 . '"</script>';
      exit;
      }
    }
    else{?>
    ...
    <div class="alert alert-danger alert-dismissable" role="alert">
        ...
        <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></a>
  ...
  <div class="alert alert-danger alert-dismissable" role="alert">
      <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
      <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></a>
      <strong>Login Gagal!</strong> Username Salah
  </div>
  <?php
  }
}
